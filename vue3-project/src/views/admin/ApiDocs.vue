      ...
      <div class="sticky-search" :class="{ hidden: scrollY < 1000 }">
        <div class="search-box">
          <input
            v-model="searchQuery"
            type="text"
            placeholder="搜索API接口（支持路径、标题、描述搜索）..."
            class="search-input"
            @input="handleSearch"
          />
            ...
            <div class="api-list">
              <div v-for="api in group.apis" :key="api.path" class="api-item">
                <div class="api-header" @click="toggleApi(api)">
                  <span class="method" :class="api.method.toLowerCase()">{{
                    api.method
                  }}</span>
                ...
                <div v-if="api.expanded" class="api-details">
                  <div v-if="api.description" class="description">
                    <strong>描述：</strong
                    ><span v-html="highlightText(api.description)"></span>
                  </div>
  ...
  },
  {
    ...
    apis: [
      ...
      },
      {
        ...
        title: "获取笔记详情",
        description:
          "根据笔记ID获取笔记详细信息，返回数据包含笔记基本信息、图片列表(images数组)、标签列表、作者信息、点赞收藏状态等",
        expanded: false,
        params: [
    ...
    apis: [
      {
        ...
        params: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "搜索类型（all, posts, users）",
          },
          {
            name: "page",
            type: "int",
        ...
        params: [
          {
            ...
            type: "file",
            required: true,
            description: "要上传的图片文件（jpg, jpeg, png, webp）",
          },
        ],
        example: `{
  "code": 200,
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "排序字段（id, fans_count, like_count, created_at）",
          },
          {
            name: "order",
            type: "string",
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            required: false,
            description:
              "排序字段（id, like_count, comment_count, created_at）",
          },
          {
            name: "order",
            type: "string",
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "排序字段（id, like_count, created_at）",
          },
          {
            name: "order",
            type: "string",
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "搜索关键词（标签名称）",
          },
          {
            name: "sort",
            type: "string",
            required: false,
            description: "排序字段（id, use_count, created_at）",
          },
          {
            name: "order",
            type: "string",
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "排序字段（id, user_id, created_at）",
          },
          {
            name: "order",
            type: "string",
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            required: false,
            description:
              "排序字段（id, follower_id, following_id, created_at）",
          },
          {
            name: "order",
            type: "string",
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "搜索关键词（通知内容）",
          },
          {
            name: "sort",
            type: "string",
            required: false,
            description: "排序字段（username, created_at）",
          },
          {
            name: "order",
            type: "string",
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "搜索关键词（用户名或IP）",
          },
          {
            name: "sort",
            type: "string",
            required: false,
            description: "排序字段（id, created_at, last_activity）",
          },
          {
            name: "order",
            type: "string",
      ...
      },
      {
        ...
        params: [
          ...
          },
          {
            ...
            type: "string",
            required: false,
            description: "排序字段（id, created_at）",
          },
          {
            name: "order",
            type: "string",
