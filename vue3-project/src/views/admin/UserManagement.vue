...
const columns = [
  ...
  { key: 'user_id', label: '小红书号', type: 'user-link', sortable: false, maxLength: 15 },
...
const formFields = [
  { key: 'user_id', label: '小红书号', type: 'text', required: true, placeholder: '请输入小红书号', maxlength: 15 },
...
const searchFields = [
  { key: 'user_id', label: '小红书号', placeholder: '搜索小红书号' },
