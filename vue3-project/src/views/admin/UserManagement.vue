...
const columns = [
  ...
  { key: 'user_id', label: '大红薯号', type: 'user-link', sortable: false, maxLength: 15 },
...
const formFields = [
  { key: 'user_id', label: '大红薯号', type: 'text', required: true, placeholder: '请输入大红薯号', maxlength: 15 },
...
const searchFields = [
  { key: 'user_id', label: '大红薯号', placeholder: '搜索大红薯号' },
