      ...
      <div class="auth-content">
        <div class="auth-header">
          <h2 class="auth-title">
            {{
              isLoginMode
                ? SITE_CONFIG.auth.loginTitle
                : SITE_CONFIG.auth.registerTitle
            }}
          </h2>
        ...
        <form @submit.prevent="handleSubmit" class="auth-form">
          <div class="form-group">
            ...
            <input
              ...
              :placeholder="
                isLoginMode
                  ? SITE_CONFIG.auth.userIdPlaceholder
                  : SITE_CONFIG.auth.userIdRegisterPlaceholder
              "
              maxlength="15"
              @input="clearError('user_id')"
            />
            <span v-if="showErrors && errors.user_id" class="error-message">{{
              errors.user_id
            }}</span>
          </div>
          ...
          <div v-if="!isLoginMode" class="form-group">
            ...
            <input
              ...
              class="form-input"
              :class="{ error: showErrors && errors.nickname }"
              placeholder="请输入昵称（少于10位）"
              maxlength="10"
              @input="clearError('nickname')"
            />
            <span v-if="showErrors && errors.nickname" class="error-message">{{
              errors.nickname
            }}</span>
          </div>
          ...
          <div class="form-group">
            ...
            />
            <span v-if="showErrors && errors.password" class="error-message">{{
              errors.password
            }}</span>
          </div>
